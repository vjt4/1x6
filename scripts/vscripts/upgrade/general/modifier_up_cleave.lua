...
local ability = self:GetParent():FindAbilityByName("generic_talent")

DoCleaveAttack(self:GetParent(), param.target, ability, param.damage*(10*self:GetStackCount()*(1 + k +0.3*self:GetParent():GetUpgradeStack("modifier_up_graypoints")) /100 ), 150, 360, 650, "particles/units/heroes/hero_magnataur/magnataur_empower_cleave_effect.vpcf")

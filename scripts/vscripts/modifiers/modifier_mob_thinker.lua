...
if attacker.owner and attacker.owner:GetQuest() == "Monkey.Quest_8" and not attacker.owner:QuestCompleted() and attacker:HasModifier("modifier_monkey_king_wukongs_command_custom_soldier") then 

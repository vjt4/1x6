...
if player then 
    ...
    and params.unit ~= self:GetParent() then 
        ...
        if tower then 
            ...
            tower:AddNewModifier(player, nil, "modifier_generic_repair", {duration = 10, tower_heal = 10})
...
if player and player.grenade_count < Grenade_Max and GameRules:GetDOTATime(false, false) >= Grenade_Timer and params.attacker then 

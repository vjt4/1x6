...
lina_fiery_soul_custom.shard_damage = 15    
...
lina_fiery_soul_custom.spell_max = 6


lina_fiery_soul_custom.max_speed = 650
lina_fiery_soul_custom.max_stack = 3

lina_fiery_soul_custom.proc_chance_init = 10
lina_fiery_soul_custom.proc_chance_inc = 10
lina_fiery_soul_custom.proc_damage = 25
...
lina_fiery_soul_custom.legendary_damage = 1.6
lina_fiery_soul_custom.legendary_cast = 3
lina_fiery_soul_custom.legendary_cd = 4

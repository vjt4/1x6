...
custom_pudge_flesh_heap.tempo_duration = 9


custom_pudge_flesh_heap.active_duration = {1, 2, 3}
custom_pudge_flesh_heap.active_heal = {1, 1.5, 2}
...
custom_pudge_flesh_heap.legendary_cd = 30
custom_pudge_flesh_heap.legendary_resist = 30

custom_pudge_flesh_heap.armor_inc = {30, 25, 20}

custom_pudge_flesh_heap.hit_str = 1.5
custom_pudge_flesh_heap.hit_cd = {10, 6}
custom_pudge_flesh_heap.hit_stun = 1
custom_pudge_flesh_heap.hit_heal = 1
...
if self:GetCaster():HasModifier("modifier_pudge_flesh_1") then 
	duration = duration + self.active_duration[self:GetCaster():GetUpgradeStack("modifier_pudge_flesh_1")]
end
...
function modifier_custom_pudge_flesh_heap_legendary:GetModifierHealthRegenPercentage()

if self:GetCaster():HasModifier("modifier_pudge_flesh_1") then 
	return self:GetAbility().active_heal[self:GetCaster():GetUpgradeStack("modifier_pudge_flesh_1")]
end
...
local cd =  self:GetAbility().hit_cd[self:GetParent():GetUpgradeStack("modifier_pudge_flesh_4")]

...
function modifier_item_urn_of_shadows_custom_passive:IsHidden()	return true
...
function modifier_item_urn_of_shadows_custom_passive:OnIntervalThink()
	...
	if self:GetParent():HasModifier("modifier_item_spirit_vessel_custom_passive") or self:GetParent():HasModifier("modifier_item_soul_keeper_custom_passive") then
		self:SetDuration(self.soul_cooldown, true)
		return
	end

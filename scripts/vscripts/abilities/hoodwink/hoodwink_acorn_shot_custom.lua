...
hoodwink_acorn_shot_custom.slow_inc = {0.5, 1, 1.5}
hoodwink_acorn_shot_custom.slow_turn = -70


hoodwink_acorn_shot_custom.stun_duration = 0.5
hoodwink_acorn_shot_custom.stun_cd = 10

hoodwink_acorn_shot_custom.armor_duration = 3
...
hoodwink_acorn_shot_custom.armor_cd = {-2, -3}
...
if self:GetCaster():HasModifier("modifier_hoodwink_acorn_4") then
	bonus = self.armor_cd[self:GetCaster():GetUpgradeStack("modifier_hoodwink_acorn_4")]
end
...
if self:GetCaster():HasModifier("modifier_hoodwink_acorn_3") then 
	duration = duration + self.slow_inc[self:GetCaster():GetUpgradeStack("modifier_hoodwink_acorn_3")]
end

...
caster:AddNewModifier(caster, main, "modifier_monkey_king_mischief_custom", {})
...
for _,skill in pairs(self.skills) do 
  if skill:GetName() == "monkey_king_primal_spring_custom" then 
    if self:GetParent():HasModifier("modifier_monkey_king_primal_spring_custom_legendary") 
      or self:GetParent():HasModifier("modifier_monkey_king_tree_dance_custom") then 

...
void_spirit_resonant_pulse_custom.mana_init = 0
void_spirit_resonant_pulse_custom.mana_inc = 100

void_spirit_resonant_pulse_custom.incoming = {-6, -9, -12}
void_spirit_resonant_pulse_custom.incoming_resist = {8, 12, 16}

void_spirit_resonant_pulse_custom.legendary_duration = 0.7

void_spirit_resonant_pulse_custom.burn_radius = 300
void_spirit_resonant_pulse_custom.burn_mana = {0.02, 0.03}
void_spirit_resonant_pulse_custom.burn_mana_base = 0
void_spirit_resonant_pulse_custom.burn_interval = 1
void_spirit_resonant_pulse_custom.burn_mana_k = 2

void_spirit_resonant_pulse_custom.health_shield = 0.10
void_spirit_resonant_pulse_custom.health_lifesteal = 0.15
void_spirit_resonant_pulse_custom.health_lifesteal_creeps = 0.33

void_spirit_resonant_pulse_custom.auto_slow = -50
void_spirit_resonant_pulse_custom.auto_slow_duration = 1

void_spirit_resonant_pulse_custom.damage = {50,75,100}
...
function modifier_void_spirit_resonant_pulse:GetModifierStatusResistanceStacking()
local bonus = 0

if self:GetParent():HasModifier("modifier_void_pulse_2") then
	bonus = self:GetAbility().incoming_resist[self:GetParent():GetUpgradeStack("modifier_void_pulse_2")]
end
  ...
  if mod and mod:GetStackCount() > 0 then 
	...
	if params.damage>=self.shield then
		...
		if self:GetParent():GetQuest() == "Void.Quest_7" and params.attacker:IsRealHero() then 
			self:GetParent():UpdateQuest(self.shield)
		end

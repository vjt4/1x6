...
custom_nevermore_shadowraze_close.legendary_cd = 0.5

custom_nevermore_shadowraze_close.duration = 0.8

custom_nevermore_shadowraze_close.stack_duration = 30	

custom_nevermore_shadowraze_close.speed_move = {4, 6, 8}
custom_nevermore_shadowraze_close.speed_duration = 4
custom_nevermore_shadowraze_close.speed_max = 3
custom_nevermore_shadowraze_close.speed_heal = {10, 20, 30}

custom_nevermore_shadowraze_close.auto_radius = 600
custom_nevermore_shadowraze_close.auto_cd = {10, 7}
custom_nevermore_shadowraze_close.auto_delay = 1.5
custom_nevermore_shadowraze_close.auto_slow_duration = 1
custom_nevermore_shadowraze_close.auto_slow = -80
custom_nevermore_shadowraze_close.auto_aoe = 0.8
...
custom_nevermore_shadowraze_far.legendary_cd = 0.5
...
custom_nevermore_shadowraze_far.stack_duration = 30	

custom_nevermore_shadowraze_far.speed_move = {4, 6, 8}
custom_nevermore_shadowraze_far.speed_duration = 4
custom_nevermore_shadowraze_far.speed_max = 3
custom_nevermore_shadowraze_far.speed_heal = {10, 20, 30}
...
custom_nevermore_shadowraze_medium.legendary_cd = 0.5

custom_nevermore_shadowraze_medium.duration = 1.5

custom_nevermore_shadowraze_medium.stack_duration = 30		

custom_nevermore_shadowraze_medium.speed_move = {4, 6, 8}
custom_nevermore_shadowraze_medium.speed_duration = 4
custom_nevermore_shadowraze_medium.speed_max = 3
custom_nevermore_shadowraze_medium.speed_heal = {10, 20, 30}
...
function CastShadowRazeOnPoint(caster, ability, point, radius, auto)
	...
	if #enemies > 0 then
		...
		if caster:HasModifier("modifier_nevermore_raze_speed") then 
			caster:AddNewModifier(caster, ability, "modifier_custom_shadowraze_speedmax", {duration = ability.speed_duration})
		end
	end
	...
	for _,enemy in pairs(enemies) do
		...
		if auto then 
			enemy:AddNewModifier(caster, ability, "modifier_custom_shadowraze_slow_auto", {duration = ability.auto_slow_duration})
		end
...
self.heal = self:GetAbility().speed_heal[self:GetCaster():GetUpgradeStack("modifier_nevermore_raze_speed")]
if not IsServer() then return end
self:SetStackCount(1)
...
self:GetAbility().speed_move[self:GetParent():GetUpgradeStack("modifier_nevermore_raze_speed")]*self:GetStackCount()
end
...
local enemies = FindUnitsInRadius(self:GetParent():GetTeamNumber(), self:GetParent():GetAbsOrigin(), nil, self:GetAbility().auto_radius,  DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_FOW_VISIBLE, FIND_CLOSEST, false)

if #enemies == 0 then return end



CreateModifierThinker(self:GetCaster(), self:GetAbility(), "modifier_custom_shadowraze_auto", {duration = self:GetAbility().auto_delay}, enemies[1]:GetAbsOrigin(), self:GetCaster():GetTeamNumber(), false)
self:GetParent():AddNewModifier(self:GetParent(), self:GetAbility(), "modifier_custom_shadowraze_cd", {duration = self:GetAbility().auto_cd[self:GetParent():GetUpgradeStack("modifier_nevermore_raze_burn")]})
end
...
self.radius = self:GetAbility():GetSpecialValueFor("shadowraze_radius")*self:GetAbility().auto_aoe

...
LinkLuaModifier("modifier_puck_coil_orb_rooted", "abilities/puck/custom_puck_illusory_orb", LUA_MODIFIER_MOTION_NONE)
...
custom_puck_illusory_orb.damage_stack_duration = 10
custom_puck_illusory_orb.damage_stack_init = 0
custom_puck_illusory_orb.damage_stack_inc = 15
...
custom_puck_illusory_orb.illusion_stun = 1.8
...
for _,thinker in ipairs(thinkers) do
  if thinker ~= self:GetParent() and thinker:HasModifier("modifier_puck_coil_orb_thinker")
     ...
     local dir2 = RotatePosition(Vector(), QAngle(0,-90,0), self.vector) 
      ...
      self.ability:StartOrb(target ,location, self:GetCaster(), 1 )
...
modifier_puck_coil_orb_rooted = class({})
function modifier_puck_coil_orb_rooted:IsHidden() return true end
function modifier_puck_coil_orb_rooted:IsPurgable() return true end
function modifier_puck_coil_orb_rooted:CheckState()
return
{
  [MODIFIER_STATE_ROOTED] = true
}
end
function modifier_puck_coil_orb_rooted:GetEffectName() return "particles/items3_fx/gleipnir_root.vpcf" end

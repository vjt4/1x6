...
alchemist_chemical_rage_custom.bonus_speed = {20,30,40}
...
alchemist_chemical_rage_custom.attack_damage = {3,4,5}
alchemist_chemical_rage_custom.attack_duration = 4
alchemist_chemical_rage_custom.attack_chance = 30

alchemist_chemical_rage_custom.damage_reduction_max = 5
alchemist_chemical_rage_custom.damage_reduction = -10
alchemist_chemical_rage_custom.damage_status = 10

alchemist_chemical_rage_custom.range_attack = 100
alchemist_chemical_rage_custom.cleave_attack = 0.40

alchemist_chemical_rage_custom.legendary_bva = 0.15

alchemist_enrage_potion = class({})

alchemist_enrage_potion.cd = {6,4}
...
function modifier_alchemist_chemical_rage_incoming:GetModifierStatusResistanceStacking()
return self:GetAbility().damage_status*self:GetStackCount()
end
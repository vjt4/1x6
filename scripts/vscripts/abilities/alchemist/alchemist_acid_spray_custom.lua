...
alchemist_acid_spray_custom.heal = 50

alchemist_acid_spray_custom.root_duration = 2
alchemist_acid_spray_custom.root_timer = 4

alchemist_acid_spray_custom.legendary_damage = 60
...
self:GetParent():EmitSound("Alch.Silence")

...
ember_spirit_activate_fire_remnant_custom.resist_damage = -8
ember_spirit_activate_fire_remnant_custom.resist_max = 5
ember_spirit_activate_fire_remnant_custom.resist_duration = 3
ember_spirit_activate_fire_remnant_custom.resist_heal = 1
ember_spirit_activate_fire_remnant_custom.resist_cd = 0.4
...
ember_spirit_activate_fire_remnant_custom.fire_building = 0.2
...
local tTargets = FindUnitsInRadius(self:GetCaster():GetTeamNumber(), self:GetParent():GetAbsOrigin(), nil, 200, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, 0, FIND_CLOSEST, false)
...
function modifier_ember_spirit_activate_fire_remnant_resist:IsHidden() return false end
function modifier_ember_spirit_activate_fire_remnant_resist:IsPurgable() return false end
function modifier_ember_spirit_activate_fire_remnant_resist:GetTexture() return "buffs/leap_resist" end
...
function modifier_ember_spirit_activate_fire_remnant_resist:GetModifierHealthRegenPercentage()
return self:GetStackCount()*self:GetAbility().resist_heal
end



function modifier_ember_spirit_activate_fire_remnant_resist:GetModifierIncomingDamage_Percentage()
return self:GetStackCount()*self:GetAbility().resist_damage
end
...
if self:GetCaster():HasModifier("modifier_ember_remnant_6")  then 
	upgrade_cooldown = self:GetCaster():FindAbilityByName("ember_spirit_activate_fire_remnant_custom").resist_cd
end

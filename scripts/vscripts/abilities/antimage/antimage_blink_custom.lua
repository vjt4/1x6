...
antimage_blink_custom.legendary_cd = -3.5
antimage_blink_custom.legendary_range = 350
antimage_blink_custom.legendary_duration = 0.2
antimage_blink_custom.legendary_damage = -40
...
antimage_blink_custom.speed_attack = {100, 150, 200}
...
antimage_blink_custom.double_count = {4,3}
antimage_blink_custom.double_heal = 0.15
...
if self:GetCaster():HasModifier("modifier_antimage_blink_6") then 
	...
	local illusion = CreateIllusions( self:GetCaster(), self:GetCaster(), {duration=self.illusion_duration, outgoing_damage=self.illusion_damage,incoming_damage=0}, 1, 0, false, true)  

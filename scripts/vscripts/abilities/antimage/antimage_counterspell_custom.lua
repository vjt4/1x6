...
antimage_counterspell_custom.legendary_damage = -50
antimage_counterspell_custom.legendary_resist = 50
...
antimage_counterspell_custom.proc_damage = {0.05, 0.08}

antimage_counterspell_custom.save_health = 0.15
...
antimage_counterspell_custom.block_damage = 0.05
antimage_counterspell_custom.block_duration = 2 
antimage_counterspell_custom.block_stun = 1

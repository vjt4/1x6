...
custom_huskar_life_break.cd_init = -1
custom_huskar_life_break.cd_inc = -1

custom_huskar_life_break.duration_heal = {-10, -15, -20}
...
custom_huskar_life_break.aoe_cast = 150



custom_huskar_life_break.double_delay = 3
custom_huskar_life_break.double_damage = {0.2, 0.3}
...
self.count = false
self:SetStackCount(self:GetAbility().double_damage[self:GetCaster():GetUpgradeStack("modifier_huskar_leap_shield")]*params.damage)

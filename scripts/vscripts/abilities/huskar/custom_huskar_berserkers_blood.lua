...
custom_huskar_berserkers_blood.regen_init = 0
...
custom_huskar_berserkers_blood.damage_cd = 12
custom_huskar_berserkers_blood.damage_max = 7
...
custom_huskar_berserkers_blood.legendary_attack = 0.04
...
custom_huskar_berserkers_blood.legendary_cd = 2 
...
local damage = self:GetParent():GetMaxHealth()*self:GetAbility().legendary_cost*self:GetAbility().legendary_interval
...
if IsClient() then 
  return (self:GetParent():GetMaxHealth() - self:GetParent():GetHealth())*self:GetAbility().legendary_attack
else 

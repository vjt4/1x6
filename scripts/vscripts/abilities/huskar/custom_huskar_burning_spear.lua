...
custom_huskar_burning_spear.double_chance = {15, 25}
custom_huskar_burning_spear.double_slow = -40
custom_huskar_burning_spear.double_slow_duration = 0.6

custom_huskar_burning_spear.legendary_cd = 15
custom_huskar_burning_spear.legendary_damage = 0.8
custom_huskar_burning_spear.legendary_stun = 0.2
custom_huskar_burning_spear.legendary_stun_max = 1.2
custom_huskar_burning_spear.legendary_range = 50
...
custom_huskar_burning_spear.reduce_heal = -1.5
custom_huskar_burning_spear.reduce_damage = -1.5

custom_huskar_burning_spear.damage_init = 2
custom_huskar_burning_spear.damage_inc = 2

custom_huskar_burning_spear.heal_init = 0.1
...
if (not params.target:IsMagicImmune())

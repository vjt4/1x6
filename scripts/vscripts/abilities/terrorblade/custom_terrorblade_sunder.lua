...
custom_terrorblade_sunder.cd_inc = {-10, -20, -30}

custom_terrorblade_sunder.stun_range = 250
custom_terrorblade_sunder.stun_stun = 3 	

custom_terrorblade_sunder.bkb_duration = 2
...
if self:GetCaster():HasModifier("modifier_terror_sunder_amplify") then
	k = k + self.cd_inc[self:GetCaster():GetUpgradeStack("modifier_terror_sunder_amplify")]/100
end

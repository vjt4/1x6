...
custom_terrorblade_metamorphosis.regen_const = 20

custom_terrorblade_metamorphosis.stats_init = 3
custom_terrorblade_metamorphosis.stats_inc = 3

custom_terrorblade_metamorphosis.legendary_cd = 4
custom_terrorblade_metamorphosis.legendary_mana = 0.035
custom_terrorblade_metamorphosis.legendary_manacost = 50

custom_terrorblade_metamorphosis.stack_interval = 1
custom_terrorblade_metamorphosis.stack_max = 10
custom_terrorblade_metamorphosis.stack_damage_init = 10
custom_terrorblade_metamorphosis.stack_damage_inc = 30
custom_terrorblade_metamorphosis.stack_move_init = 10
custom_terrorblade_metamorphosis.stack_move_inc = 10

custom_terrorblade_metamorphosis.range_range = 130
...
custom_terrorblade_metamorphosis.lowhp_heal = 0.25
custom_terrorblade_metamorphosis.lowhp_duration = 3
...
if self:GetCaster():HasModifier("modifier_terror_meta_legendary") then 
	return self.legendary_manacost
end
...
function modifier_custom_terrorblade_metamorphosis:GetModifierConstantHealthRegen()
local regen = 0
if self:GetParent():HasModifier("modifier_terror_meta_regen") then 
	regen = self:GetAbility().regen_const
end
return regen
end

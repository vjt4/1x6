...
NO_BANNED_HEROES = {"npc_dota_hero_sven" }
...
function hero_select:PickHero(id, name, random)
    ...
    if wisp then
        ...
        UTIL_Remove(wisp)
        my_game:initiate_player(hero, Pause_Time, random)

    

        if hero and hero:GetUnitName() == "npc_dota_hero_monkey_king" then

            local monkey_king_ultimate = hero:FindAbilityByName("monkey_king_wukongs_command_custom")
...
hero_changes = 
{
    ...
    ["npc_dota_hero_phantom_assassin"] = {"Stifling_Dagger","Blur","Coup_de_Grace","Scepter"},
    ["npc_dota_hero_huskar"] = {"Inner_Fire","Berserkers_Blood","Berserkers_Blood","Life_Break","Life_Break","Shard"},
    ["npc_dota_hero_nevermore"] = {"Shadowraze","Shadowraze","Necromastery","Requiem","Shard"},
    ["npc_dota_hero_legion_commander"] = {"Odds","Odds","Duel","Duel","Duel","Scepter"},
    ["npc_dota_hero_queenofpain"] = {"Scepter","Sonic"},
    ["npc_dota_hero_terrorblade"] = {"Reflection","Illusion","Meta","Scepter"},
    ["npc_dota_hero_bristleback"] = {"Goo","Goo","Goo","Spray","Warpath"},
    ["npc_dota_hero_puck"] = {"Coil","Orb","Shift","Shift","Coil","Coil"},
    ["npc_dota_hero_void_spirit"] = {"Remnant","Remnant","Astral","Pulse","Pulse","Step","Scepter"},
    ["npc_dota_hero_ember_spirit"] = {"Fist","Guard","Guard","FireRemnant","FireRemnant","Shard"},
    ["npc_dota_hero_pudge"] = {"Hook","Flesh","Dismember","Dismember","Shard","Scepter"},
    ["npc_dota_hero_hoodwink"] = {"Bush","Sharp","Sharp","Scepter"},
    ["npc_dota_hero_skeleton_king"] = {"blast","reincarnation"},
    ["npc_dota_hero_lina"] = {"Array","Soul","Soul","Scepter"},
    ["npc_dota_hero_troll_warlord"] = {"rage","axes","fervor","fervor","trance","shard"},
    ["npc_dota_hero_axe"] = {"call","hunger","helix","culling","culling","culling","Shard"},
    ["npc_dota_hero_alchemist"] = {"Acid","Greed","Greed"},
    ["npc_dota_hero_ogre_magi"] = { "Ignite","Bloodlust","Shard", "Scepter", "Scepter", "Fireblast"},
    ["npc_dota_hero_antimage"] = {"Shard","Manabreak", "antimage_blink", "counterspell","manavoid", "Scepter"},
    ["npc_dota_hero_primal_beast"] = {"Scepter","Onslaught", "Uproar"},
    ["npc_dota_hero_marci"] = {"dispose","rebound","sidekick","sidekick","unleash","unleash","shard"},
    ["npc_dota_hero_templar_assassin"] = {"Refraction","Meld","Psiblades","Psiblades","Psionic","Psionic","Scepter","Scepter","Shard"},
    ...
    ["npc_dota_hero_zuus"] = {"Armor","Bolt","Wrath","Wrath","Scepter","Shard"},
    ["npc_dota_hero_leshrac"] = {"Nova","Shard","Shard"},
    ["npc_dota_hero_crystal_maiden"] = {"Crystal","Frostbite","Frostbite","Arcane","Arcane","Freezing","Freezing"},
    ["npc_dota_hero_snapfire"] = {"Cookie", "Cookie", "Shredder", "Shredder", "Shredder", "Kisses", "Scepter"},
    ["npc_dota_hero_sven"] = {"Cleave", "God", "God", "Scepter", "Shard"},
}
